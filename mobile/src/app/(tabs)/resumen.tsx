          ...
          <View style={styles.doubleBezelOuter}>
            <View style={styles.doubleBezelInner}>
              <View style={styles.heroHeader}>
                ...
                <Pressable onPress={() => setShowFinancials(!showFinancials)} style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: '#F1F5F9', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 12 }}>
                  {showFinancials ? (
                    <EyeOff size={14} color="#64748B" style={{ marginRight: 4 }} />
                  ) : (
                    <Eye size={14} color="#64748B" style={{ marginRight: 4 }} />
                  )}
                  <Text style={{ fontSize: 11, color: '#64748B', fontWeight: '600' }}>{showFinancials ? 'Ocultar' : 'Mostrar'}</Text>
                </Pressable>
              </View>
              <Text style={styles.heroValue}>
                {showFinancials ? formatCurrency(stats.recaudacion_total || 0) : '****'}
              </Text>
              ...
              <View style={styles.heroGrid}>
                ...
                <View style={styles.heroStatItem}>
                  ...
                  <Text style={[styles.heroStatValue, { color: '#10B981' }]}>
                    {showFinancials ? formatCurrency(stats.recaudacion_cobrada || 0) : '****'}
                  </Text>
                </View>
                {/* Pendiente */}
                <View style={styles.heroStatItem}>
                  ...
                  <Text style={[styles.heroStatValue, { color: '#D97706' }]}>
                    {showFinancials ? formatCurrency(stats.recaudacion_pendiente || 0) : '****'}
                  </Text>
                </View>
              </View>
            </View>
                ...
                return (
                  <View key={method} style={styles.productCard}>
                    ...
                    <View style={styles.productInfo}>
                      <Text style={styles.productValue}>{showFinancials ? formatCurrency(amount) : '****'}</Text>
